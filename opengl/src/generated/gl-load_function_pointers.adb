...
procedure GL.Load_Function_Pointers is
   ...
   function Load_T195 is new Load (T195);
begin
   ...
   GL.API.Buffer_Storage := Load_T120 ("glBufferStorage");
   GL.API.Texture_Buffer_Data := Load_T121 ("glTexBuffer");
   GL.API.Map_Buffer := Load_T122 ("glMapBuffer");
   GL.API.Map_Buffer_Range := Load_T123 ("glMapBufferRange");
   GL.API.Buffer_Pointer := Load_T124 ("glGetBufferPointerv");
   GL.API.Buffer_Sub_Data := Load_T125 ("glBufferSubData");
   GL.API.Get_Buffer_Sub_Data := Load_T125 ("glGetBufferSubData");
   GL.API.Unmap_Buffer := Load_T126 ("glUnmapBuffer");
   GL.API.Get_Buffer_Parameter_Access_Kind := Load_T127 ("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Bool := Load_T128 ("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Size := Load_T129 ("glGetBufferParameteriv");
   GL.API.Get_Buffer_Parameter_Usage := Load_T130 ("glGetBufferParameteriv");
   GL.API.Invalidate_Buffer_Data := Load_T131 ("glInvalidateBufferData");
   GL.API.Invalidate_Buffer_Sub_Data := Load_T132 ("glInvalidateBufferSubData");
   GL.API.Flush_Mapped_Buffer_Range := Load_T133 ("glFlushMappedBufferRange");
   GL.API.Gen_Vertex_Arrays := Load_T134 ("glGenVertexArrays");
   GL.API.Delete_Vertex_Arrays := Load_T135 ("glDeleteVertexArrays");
   GL.API.Bind_Vertex_Array := Load_T136 ("glBindVertexArray");
   GL.API.Gen_Renderbuffers := Load_T137 ("glGenRenderbuffers");
   GL.API.Delete_Renderbuffers := Load_T138 ("glDeleteBuffers");
   GL.API.Renderbuffer_Storage := Load_T139 ("glRenderbufferStorage");
   GL.API.Renderbuffer_Storage_Multisample := Load_T140 ("glRenderbufferStorageMultisample");
   GL.API.Bind_Renderbuffer := Load_T141 ("glBindRenderbuffer");
   GL.API.Get_Renderbuffer_Parameter_Int := Load_T142 ("glGetRenderbufferParameteriv");
   GL.API.Get_Renderbuffer_Parameter_Internal_Format := Load_T143 ("glGetRenderbufferParameteriv");
   GL.API.Clamp_Color := Load_T144 ("glClampColor");
   GL.API.Gen_Framebuffers := Load_T145 ("glGenFramebuffers");
   GL.API.Delete_Framebuffers := Load_T146 ("glDeleteFramebuffers");
   GL.API.Bind_Framebuffer := Load_T147 ("glBindFramebuffer");
   GL.API.Check_Framebuffer_Status := Load_T148 ("glCheckFramebufferStatus");
   GL.API.Framebuffer_Renderbuffer := Load_T149 ("glFramebufferRenderbuffer");
   GL.API.Framebuffer_Texture := Load_T150 ("glFramebufferTexture");
   GL.API.Framebuffer_Texture_Layer := Load_T151 ("glFramebufferTextureLayer");
   GL.API.Blit_Framebuffer := Load_T152 ("glBlitFramebuffer");
   GL.API.Invalidate_Framebuffer := Load_T153 ("glInvalidateFramebuffer");
   GL.API.Invalidate_Sub_Framebuffer := Load_T154 ("glInvalidateSubFramebuffer");
   GL.API.Framebuffer_Parameter_Size := Load_T155 ("glFramebufferParameteri");
   GL.API.Framebuffer_Parameter_Bool := Load_T156 ("glFramebufferParameteri");
   GL.API.Get_Framebuffer_Parameter_Size := Load_T157 ("glGetFramebufferParameteriv");
   GL.API.Get_Framebuffer_Parameter_Bool := Load_T158 ("glGetFramebufferParameteriv");
   GL.API.Gen_Queries := Load_T159 ("glGenQueries");
   GL.API.Delete_Queries := Load_T160 ("glDeleteQueries");
   GL.API.Is_Query := Load_T161 ("glIsQuery");
   GL.API.Get_Query_Object := Load_T162 ("glGetQueryObjectuiv");
   GL.API.Begin_Query := Load_T163 ("glBeginQuery");
   GL.API.End_Query := Load_T164 ("glEndQuery");
   GL.API.Begin_Query_Indexed := Load_T165 ("glBeginQueryIndexed");
   GL.API.End_Query_Indexed := Load_T166 ("glEndQueryIndexed");
   GL.API.Query_Counter := Load_T167 ("glQueryCounter");
   GL.API.Get_Shader_Param := Load_T168 ("glGetShaderiv");
   GL.API.Get_Shader_Type := Load_T169 ("glGetShaderiv");
   GL.API.Create_Shader := Load_T170 ("glCreateShader");
   GL.API.Delete_Shader := Load_T171 ("glDeleteShader");
   GL.API.Shader_Source := Load_T172 ("glShaderSource");
   GL.API.Get_Shader_Source := Load_T173 ("glGetShaderSource");
   GL.API.Compile_Shader := Load_T171 ("glCompileShader");
   GL.API.Release_Shader_Compiler := Load_T71 ("glReleaseShaderCompiler");
   GL.API.Get_Shader_Info_Log := Load_T173 ("glGetShaderInfoLog");
   GL.API.Create_Program := Load_T174 ("glCreateProgram");
   GL.API.Delete_Program := Load_T175 ("glDeleteProgram");
   GL.API.Get_Program_Param := Load_T176 ("glGetProgramiv");
   GL.API.Attach_Shader := Load_T177 ("glAttachShader");
   GL.API.Link_Program := Load_T175 ("glLinkProgram");
   GL.API.Get_Program_Info_Log := Load_T178 ("glGetProgramInfoLog");
   GL.API.Get_Program_Stage := Load_T179 ("glGetProgramStageiv");
   GL.API.Get_Subroutine_Index := Load_T180 ("glGetSubroutineIndex");
   GL.API.Get_Subroutine_Uniform_Location := Load_T181 ("glGetSubroutineUniformLocation");
   GL.API.Use_Program := Load_T175 ("glUseProgram");
   GL.API.Validate_Program := Load_T175 ("glValidateProgram");
   GL.API.Get_Uniform_Location := Load_T182 ("glGetUniformLocation");
   GL.API.Bind_Attrib_Location := Load_T183 ("glBindAttribLocation");
   GL.API.Get_Attrib_Location := Load_T184 ("glGetAttribLocation");
   GL.API.Vertex_Attrib_Pointer := Load_T185 ("glVertexAttribPointer");
   GL.API.Vertex_AttribI_Pointer := Load_T186 ("glVertexAttribIPointer");
   GL.API.Vertex_AttribL_Pointer := Load_T186 ("glVertexAttribLPointer");
   GL.API.Enable_Vertex_Attrib_Array := Load_T187 ("glEnableVertexAttribArray");
   GL.API.Disable_Vertex_Attrib_Array := Load_T187 ("glDisableVertexAttribArray");
   GL.API.Get_Attached_Shaders := Load_T188 ("glGetAttachedShaders");
   GL.API.Bind_Frag_Data_Location := Load_T189 ("glBindFragDataLocation");
   GL.API.Get_Frag_Data_Location := Load_T190 ("glGetFragDataLocation");
   GL.API.Begin_Transform_Feedback := Load_T191 ("glBeginTransformFeedback");
   GL.API.End_Transform_Feedback := Load_T71 ("glEndTransformFeedback");
   GL.API.Get_Transform_Feedback_Varying := Load_T192 ("glGetTransformFeedbackVarying");
   GL.API.Transform_Feedback_Varyings := Load_T193 ("glTransformFeedbackVaryings");
   GL.API.Set_Patch_Parameter_Int := Load_T194 ("glPatchParameteri");
   GL.API.Set_Patch_Parameter_Float_Array := Load_T195 ("glPatchParameterfv");
