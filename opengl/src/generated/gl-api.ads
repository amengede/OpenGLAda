...
private package GL.API is
   ...
   type T120 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Low_Level.SizeIPtr; P3 : System.Address; P4 : Low_Level.Bitfield);
   pragma Convention (StdCall, T120);
   type T121 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Pixels.Internal_Format; P3 : UInt);
   pragma Convention (StdCall, T121);
   type T122 is access function (P1 : Low_Level.Enums.Buffer_Kind; P2 : Objects.Access_Kind) return System.Address;
   pragma Convention (StdCall, T122);
   type T123 is access function (P1 : Low_Level.Enums.Buffer_Kind; P2 : Low_Level.IntPtr; P3 : Low_Level.SizeIPtr; P4 : Low_Level.Bitfield) return System.Address;
   pragma Convention (StdCall, T123);
   type T124 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Pointer_Param; P3 : out System.Address);
   pragma Convention (StdCall, T124);
   type T125 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Low_Level.IntPtr; P3 : Low_Level.SizeIPtr; P4 : System.Address);
   pragma Convention (StdCall, T125);
   type T126 is access procedure (P1 : Low_Level.Enums.Buffer_Kind);
   pragma Convention (StdCall, T126);
   type T127 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Objects.Access_Kind);
   pragma Convention (StdCall, T127);
   type T128 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Low_Level.Bool);
   pragma Convention (StdCall, T128);
   type T129 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Size);
   pragma Convention (StdCall, T129);
   type T130 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Enums.Buffer_Param; P3 : out Objects.Buffers.Buffer_Usage);
   pragma Convention (StdCall, T130);
   type T131 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T131);
   type T132 is access procedure (P1 : UInt; P2 : Low_Level.IntPtr; P3 : Low_Level.SizeIPtr);
   pragma Convention (StdCall, T132);
   type T133 is access procedure (P1 : Low_Level.Enums.Buffer_Kind; P2 : Low_Level.IntPtr; P3 : Low_Level.SizeIPtr);
   pragma Convention (StdCall, T133);
   type T134 is access procedure (P1 : Size; P2 : out UInt);
   pragma Convention (StdCall, T134);
   type T135 is access procedure (P1 : Size; P2 : UInt_Array);
   pragma Convention (StdCall, T135);
   type T136 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T136);
   type T137 is access procedure (P1 : Size; P2 : out UInt);
   pragma Convention (StdCall, T137);
   type T138 is access procedure (P1 : Size; P2 : UInt_Array);
   pragma Convention (StdCall, T138);
   type T139 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Pixels.Internal_Format; P3, P4 : Size);
   pragma Convention (StdCall, T139);
   type T140 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Size; P3 : Pixels.Internal_Format; P4, P5 : Size);
   pragma Convention (StdCall, T140);
   type T141 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : UInt);
   pragma Convention (StdCall, T141);
   type T142 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Enums.Getter.Renderbuffer_Parameter; P3 : out Int);
   pragma Convention (StdCall, T142);
   type T143 is access procedure (P1 : Low_Level.Enums.Renderbuffer_Kind; P2 : Enums.Getter.Renderbuffer_Parameter; P3 : out Pixels.Internal_Format);
   pragma Convention (StdCall, T143);
   type T144 is access procedure (P1 : Enums.Clamp_Color_Param; P2 : Low_Level.Bool);
   pragma Convention (StdCall, T144);
   type T145 is access procedure (P1 : Size; P2 : out UInt);
   pragma Convention (StdCall, T145);
   type T146 is access procedure (P1 : Size; P2 : UInt_Array);
   pragma Convention (StdCall, T146);
   type T147 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : UInt);
   pragma Convention (StdCall, T147);
   type T148 is access function (P1 : Low_Level.Enums.Framebuffer_Kind) return Objects.Framebuffers.Framebuffer_Status;
   pragma Convention (StdCall, T148);
   type T149 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Objects.Framebuffers.Attachment_Point; P3 : Low_Level.Enums.Renderbuffer_Kind; P4 : UInt);
   pragma Convention (StdCall, T149);
   type T150 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Objects.Framebuffers.Attachment_Point; P3 : UInt; P4 : Objects.Textures.Mipmap_Level);
   pragma Convention (StdCall, T150);
   type T151 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Objects.Framebuffers.Attachment_Point; P3 : UInt; P4 : Objects.Textures.Mipmap_Level; P5 : Int);
   pragma Convention (StdCall, T151);
   type T152 is access procedure (P1, P2, P3, P4, P5, P6, P7, P8 : Int; P9 : Low_Level.Bitfield; P10 : Objects.Textures.Magnifying_Function);
   pragma Convention (StdCall, T152);
   type T153 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Size; P3 : Objects.Framebuffers.Attachment_List);
   pragma Convention (StdCall, T153);
   type T154 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Size; P3 : Objects.Framebuffers.Attachment_List; P4, P5 : Int; P6, P7 : Size);
   pragma Convention (StdCall, T154);
   type T155 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : Size);
   pragma Convention (StdCall, T155);
   type T156 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : Low_Level.Bool);
   pragma Convention (StdCall, T156);
   type T157 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : out Size);
   pragma Convention (StdCall, T157);
   type T158 is access procedure (P1 : Low_Level.Enums.Framebuffer_Kind; P2 : Enums.Framebuffer_Param; P3 : out Low_Level.Bool);
   pragma Convention (StdCall, T158);
   type T159 is access procedure (P1 : Size; P2 : out UInt);
   pragma Convention (StdCall, T159);
   type T160 is access procedure (P1 : Size; P2 : UInt_Array);
   pragma Convention (StdCall, T160);
   type T161 is access function (P1 : UInt) return Boolean;
   pragma Convention (StdCall, T161);
   type T162 is access procedure (P1 : UInt; P2 : Low_Level.Enums.Query_Results; P3 : out UInt);
   pragma Convention (StdCall, T162);
   type T163 is access procedure (P1 : Low_Level.Enums.Query_Param; P2 : UInt);
   pragma Convention (StdCall, T163);
   type T164 is access procedure (P1 : Low_Level.Enums.Query_Param);
   pragma Convention (StdCall, T164);
   type T165 is access procedure (P1 : Low_Level.Enums.Query_Param; P2, P3 : UInt);
   pragma Convention (StdCall, T165);
   type T166 is access procedure (P1 : Low_Level.Enums.Query_Param; P2 : UInt);
   pragma Convention (StdCall, T166);
   type T167 is access procedure (P1 : UInt; P2 : Low_Level.Enums.Query_Param);
   pragma Convention (StdCall, T167);
   type T168 is access procedure (P1 : UInt; P2 : Enums.Shader_Param; P3 : out Int);
   pragma Convention (StdCall, T168);
   type T169 is access procedure (P1 : UInt; P2 : Enums.Shader_Param; P3 : out Objects.Shaders.Shader_Type);
   pragma Convention (StdCall, T169);
   type T170 is access function (P1 : Objects.Shaders.Shader_Type) return UInt;
   pragma Convention (StdCall, T170);
   type T171 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T171);
   type T172 is access procedure (P1 : UInt; P2 : Size; P3 : Low_Level.Char_Access_Array; P4 : Int_Array);
   pragma Convention (StdCall, T172);
   type T173 is access procedure (P1 : UInt; P2 : Size; P3 : out Size; P4 : in out String);
   pragma Convention (StdCall, T173);
   type T174 is access function return UInt;
   pragma Convention (StdCall, T174);
   type T175 is access procedure (P1 : UInt);
   pragma Convention (StdCall, T175);
   type T176 is access procedure (P1 : UInt; P2 : Enums.Program_Param; P3 : out Int);
   pragma Convention (StdCall, T176);
   type T177 is access procedure (P1, P2 : UInt);
   pragma Convention (StdCall, T177);
   type T178 is access procedure (P1 : UInt; P2 : Size; P3 : out Size; P4 : in out String);
   pragma Convention (StdCall, T178);
   type T179 is access procedure (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Enums.Program_Stage_Param; P4 : out Size);
   pragma Convention (StdCall, T179);
   type T180 is access function (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Interfaces.C.char_array) return Objects.Programs.Subroutine_Index_Type;
   pragma Convention (StdCall, T180);
   type T181 is access function (P1 : UInt; P2 : Objects.Shaders.Shader_Type; P3 : Interfaces.C.char_array) return Objects.Programs.Uniform_Location_Type;
   pragma Convention (StdCall, T181);
   type T182 is access function (P1 : UInt; P2 : C.char_array) return Uniforms.Uniform;
   pragma Convention (StdCall, T182);
   type T183 is access procedure (P1 : UInt; P2 : Attributes.Attribute; P3 : C.char_array);
   pragma Convention (StdCall, T183);
   type T184 is access function (P1 : UInt; P2 : C.char_array) return Attributes.Attribute;
   pragma Convention (StdCall, T184);
   type T185 is access procedure (P1 : Attributes.Attribute; P2 : Component_Count; P3 : Numeric_Type; P4 : Low_Level.Bool; P5 : Size; P6 : Int);
   pragma Convention (StdCall, T185);
   type T186 is access procedure (P1 : Attributes.Attribute; P2 : Component_Count; P3 : Numeric_Type; P4 : Size; P5 : Int);
   pragma Convention (StdCall, T186);
   type T187 is access procedure (P1 : Attributes.Attribute);
   pragma Convention (StdCall, T187);
   type T188 is access procedure (P1 : UInt; P2 : Size; P3 : out Size; P4 : in out UInt_Array);
   pragma Convention (StdCall, T188);
   type T189 is access procedure (P1 : UInt; P2 : Buffers.Draw_Buffer_Index; P3 : Interfaces.C.char_array);
   pragma Convention (StdCall, T189);
   type T190 is access function (P1 : UInt; P2 : Interfaces.C.char_array) return Int;
   pragma Convention (StdCall, T190);
   type T191 is access procedure (P1 : Connection_Mode);
   pragma Convention (StdCall, T191);
   type T192 is access procedure (P1 : UInt; P2 : Int; P3 : Size; P4 : out Size; P5 : out Size; P6 : out GL.Objects.Programs.Active_Attribute; P7 : in out Interfaces.C.char_array);
   pragma Convention (StdCall, T192);
   type T193 is access procedure (P1 : UInt; P2 : Size; P3 : Low_Level.Char_Access_Array; P4 : GL.Objects.Programs.Buffer_Mode);
   pragma Convention (StdCall, T193);
   type T194 is access procedure (P1 : Enums.Patch_Parameter_Int; P2 : Int);
   pragma Convention (StdCall, T194);
   type T195 is access procedure (P1 : Enums.Patch_Parameter_Float_Array; P2 : Single_Array);
   pragma Convention (StdCall, T195);
   procedure Flush;
   ...
   Buffer_Data : T119;
   Buffer_Storage : T120;
   Texture_Buffer_Data : T121;
   Map_Buffer : T122;
   Map_Buffer_Range : T123;
   Buffer_Pointer : T124;
   Buffer_Sub_Data : T125;
   Get_Buffer_Sub_Data : T125;
   Unmap_Buffer : T126;
   Get_Buffer_Parameter_Access_Kind : T127;
   Get_Buffer_Parameter_Bool : T128;
   Get_Buffer_Parameter_Size : T129;
   Get_Buffer_Parameter_Usage : T130;
   Invalidate_Buffer_Data : T131;
   Invalidate_Buffer_Sub_Data : T132;
   Flush_Mapped_Buffer_Range : T133;
   Gen_Vertex_Arrays : T134;
   Delete_Vertex_Arrays : T135;
   Bind_Vertex_Array : T136;
   Gen_Renderbuffers : T137;
   Delete_Renderbuffers : T138;
   Renderbuffer_Storage : T139;
   Renderbuffer_Storage_Multisample : T140;
   Bind_Renderbuffer : T141;
   Get_Renderbuffer_Parameter_Int : T142;
   Get_Renderbuffer_Parameter_Internal_Format : T143;
   ...
   Gen_Framebuffers : T145;
   Delete_Framebuffers : T146;
   Bind_Framebuffer : T147;
   Check_Framebuffer_Status : T148;
   Framebuffer_Renderbuffer : T149;
   Framebuffer_Texture : T150;
   Framebuffer_Texture_Layer : T151;
   Blit_Framebuffer : T152;
   Invalidate_Framebuffer : T153;
   Invalidate_Sub_Framebuffer : T154;
   Framebuffer_Parameter_Size : T155;
   Framebuffer_Parameter_Bool : T156;
   Get_Framebuffer_Parameter_Size : T157;
   Get_Framebuffer_Parameter_Bool : T158;
   Gen_Queries : T159;
   Delete_Queries : T160;
   Is_Query : T161;
   Get_Query_Object : T162;
   Begin_Query : T163;
   End_Query : T164;
   Begin_Query_Indexed : T165;
   End_Query_Indexed : T166;
   Query_Counter : T167;
   Get_Shader_Param : T168;
   Get_Shader_Type : T169;
   Create_Shader : T170;
   Delete_Shader : T171;
   Shader_Source : T172;
   Get_Shader_Source : T173;
   Compile_Shader : T171;
   Release_Shader_Compiler : T71;
   Get_Shader_Info_Log : T173;
   Create_Program : T174;
   Delete_Program : T175;
   Get_Program_Param : T176;
   Attach_Shader : T177;
   Link_Program : T175;
   Get_Program_Info_Log : T178;
   Get_Program_Stage : T179;
   Get_Subroutine_Index : T180;
   Get_Subroutine_Uniform_Location : T181;
   Use_Program : T175;
   Validate_Program : T175;
   Get_Uniform_Location : T182;
   Bind_Attrib_Location : T183;
   Get_Attrib_Location : T184;
   Vertex_Attrib_Pointer : T185;
   Vertex_AttribI_Pointer : T186;
   Vertex_AttribL_Pointer : T186;
   Enable_Vertex_Attrib_Array : T187;
   Disable_Vertex_Attrib_Array : T187;
   Get_Attached_Shaders : T188;
   Bind_Frag_Data_Location : T189;
   Get_Frag_Data_Location : T190;
   Begin_Transform_Feedback : T191;
   End_Transform_Feedback : T71;
   Get_Transform_Feedback_Varying : T192;
   Transform_Feedback_Varyings : T193;
   Set_Patch_Parameter_Int : T194;
   Set_Patch_Parameter_Float_Array : T195;
